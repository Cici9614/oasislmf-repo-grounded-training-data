...
### 6.1 准备 OasisLMF 源码（repo-grounded 数据来源）

本项目不在仓库中包含第三方源码。请先将 OasisLMF 克隆到 `data/raw_repo/`：

```bash
git clone https://github.com/OasisLMF/OasisLMF.git data/raw_repo
```

### 6.2 在项目根目录执行以下命令即可复现全部产物：
